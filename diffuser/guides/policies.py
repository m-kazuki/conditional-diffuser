...
class Policy:
    ...
    def __call__(self, conditions, debug=False, batch_size=1):
        ...
        # conditions: e.g. {383: [7,9,0,0], 0: [7,1,-1,0]}
        conditions = self._format_conditions(conditions, batch_size) # array -> tensor
        ...
        sample = self.diffusion_model(conditions) # shape: (bs, diffusion.horizon, 6), 6=action_dim(2)+state_dim(4)
        sample = utils.to_np(sample)

        ## extract action [ batch_size x horizon x transition_dim ]
        actions = sample[:, :, :self.action_dim]
        actions = self.normalizer.unnormalize(actions, 'actions') # normalized data generated by DDPM -> original data
        ...
        # if debug:
        normed_observations = sample[:, :, self.action_dim:] # generated state
